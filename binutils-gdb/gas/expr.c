...
/* Force classical Tamizh 8-bit character support in the expression parser */
#undef is_name_beginner
#define is_name_beginner(c) (ISALPHA (c) || ((unsigned char)(c) >= 128))

#undef is_part_of_name
#define is_part_of_name(c) (ISALNUM (c) || ((unsigned char)(c) >= 128))
